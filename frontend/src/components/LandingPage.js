    ...
    <div className="promo-modal-overlay" onClick={onClose}>
        <div className="promo-modal" onClick={e => e.stopPropagation()}>
            ...
            <p className="bonus-highlight">
                Register now to get an instant <strong>₹50 Bonus</strong> and up to a <strong>300% Deposit Bonus</strong> on your first investment!
            </p>
        ...
        <div className="landing-page">
            {showPromo && (
                <PromoModal
                    ...
                    onRegisterClick={() => { setShowPromo(false); scrollToAuth('register'); }}
                />
            )}
            ...
            <main id="main-content" className="main-content">
                <section className="hero-content-below-image">
                    ...
                    <p>
                        Don't be. We are with you in shaping your financial situation for the better. With our investment products that provide daily income and exciting games that offer big wins, your journey to financial independence starts now.
                    </p>
                </section>

                <section id="inflation" className="content-section">
                    <div className="content-image">
                        <img src={inflationImage} alt="Money losing value" />
                    </div>
                    <div className="content-text">
                        <h2>Don't Let Inflation Eat Your Savings</h2>
                        <p>
                            Every day, the money in your bank account is losing purchasing power. To truly grow your wealth and secure your future, your money needs to work for you and grow faster than inflation.
                        </p>
                    </div>
                </section>
                            ...
                            {authView === 'login' ? (
                                <form onSubmit={handleLogin} className="auth-form">
                                    ...
                                    <p className="auth-switch">
                                        Don't have an account? <button type="button" onClick={() => setAuthView('register')}>Sign Up</button>
                                    </p>
                                </form>
                            ) : (
                                <form onSubmit={handleRegisterSubmit} className="auth-form">
                                    ...
                                    <div className="terms-checkbox">
                                        ...
                                        <label htmlFor="terms">I accept all the <a href="#terms" target="_blank" rel="noreferrer">Terms and Conditions</a></label>
                                    </div>
                                    <button className="cta-button" type="submit" disabled={loading || !termsAccepted}>
                                        {loading ? 'Registering...' : 'Register'}
                                    </button>
                                    <p className="auth-switch">
                                        Already have an account? <button type="button" onClick={() => setAuthView('login')}>Sign In</button>
                                    </p>
                                </form>
                            )}
                        </div>
                ...
                <section id="about" className="content-section">
                    <h2>Who Are We?</h2>
                    <p>
                        InvestmentPlus is a premier platform dedicated to democratizing wealth creation. We believe that everyone, regardless of their financial background, deserves the opportunity to build a secure and prosperous future.
                        By combining expertly managed, high-yield investment products with fair and engaging skill-based games, we provide a unique and powerful ecosystem for our members to grow their capital and achieve their financial goals.
                    </p>
                ...
                <footer className="landing-footer">
                    ...
                    <p className="disclaimer">
                        *Disclaimer: Investments are subject to market risks. Please read all scheme-related documents carefully.
                        Gaming involves an element of financial risk and may be addictive. Please play responsibly and at your own risk.
                        InvestmentPlus is a privately operated platform and is not directly affiliated with or regulated by SEBI or RBI.
                    </p>
                </footer>
            </main>
        </div>
