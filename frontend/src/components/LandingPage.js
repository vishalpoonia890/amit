...
import { 
    FidelityLogoIcon, LoginIcon, BankVsInvestIcon, PassiveIncomeIcon, 
    FinancialFreedomIcon, SmartInvestingIcon, LongTermGrowthIcon, DiversificationIcon 
} from './Icons';
...
const PromoModal = ({ onClose, onRegisterClick }) => (
    <div className="promo-modal-overlay" onClick={onClose}>
        <div className="promo-modal" onClick={e => e.stopPropagation()}>
            ...
            <img src={promoImage} alt="Special Promotion" className="promo-modal-image"/>
