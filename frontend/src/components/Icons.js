...
export const SpadeIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12,2C9.2,2,6.7,3.1,4.9,4.9C3.1,6.7,2,9.2,2,12s1.1,5.3,2.9,7.1C6.7,20.9,9.2,22,12,22s5.3-1.1,7.1-2.9 c1.8-1.8,2.9-4.3,2.9-7.1s-1.1-5.3-2.9-7.1C17.3,3.1,14.8,2,12,2z M12,20c-4.4,0-8-3.6-8-8s3.6-8,8-8s8,3.6,8,8S16.4,20,12,20z M13,11.9l3.5-3.5l1.4,1.4L14.4,13L13,11.9z M11.9,13L13,14.1l-3.5,3.5l-1.4-1.4L11.9,13z M10.1,11l-3.5,3.5l-1.4-1.4 l3.5-3.5L10.1,11z M11,10.1l1.1-1.1l-3.5-3.5l-1.4,1.4L11,10.1z"/>
    </svg>
);
